...
class Prostate_lesionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.phase == "train":
            ...
            if self.classes == 3:
                if self.train_label_list[idx] == 1 or self.train_label_list[idx] == 2:
                    target = 0
            ...
            if self.classes == 3:
                if self.test_label_list[idx] == 1 or self.test_label_list[idx] == 2:
                    target = 0
            ...
            if self.classes == 3:
                if self.inf_label_list[idx] == 1 or self.inf_label_list[idx] == 2:
                    target = 0
